...
function delete()
{
	...
	for($i=1; $i<=$nrow; $i++) 
	{
 		$kode_role=$_POST["cek$i"];
  		if($kode_role!="")
		{
			$strsql="BEGIN DELETE_MENU_TAKTERPAKAI('$kode_role'); END;";
			//echo $strsql."<br>";
			$q=oci_parse($conn,$strsql);
			oci_execute($q);
		}
	}
	header("location:cek_menu_tak_terpakai.php");
...
function open()
{
	...
	$strsql="select count(*) as JUMLAH from V_MENU_TAKTERPAKAI";
	$q=oci_parse($conn,$strsql);
	oci_execute($q);
	...
	else
	{
		...
		while ($row=oci_fetch_assoc($q)) 
		{
			...
			$datatmpl.="<td align='left'>$nama_menu</td>";
			$datatmpl.="<td align='left'>$link</td>";
			$datatmpl.="</tr>";
		}
		$datatmpl.="<tr>
  ...
  <tr>
    ...
    <td width='960px'><table width="100%"  border="0" align="center" class="outside_border">
        ...
        <? require_once("../inc_menu.php"); ?>
                    <tr>
                      <td width="100%" align="center" class="title_banner">CEK MENU TAK TERPAKAI</td>
                    </tr>
        <tr>
                    ...
                    <tr>
                      <td height="80" valign="top" bordercolor="#999999"><table width="100%" border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr class="table_header">
                          ...
                          <td  width="177" align="center" >Nama Menu</td>
                          <td  width="342" align="center" >Link</td>
                        </tr>
                        </thead>
                        <tbody id="mytable">
                        	<?=$datatmpl;?>
