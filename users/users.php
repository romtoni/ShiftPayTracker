...
function save()
{
	...
	$strsql="BEGIN VC_INSERT_USERS('$username','$password',$role); END;";
	// echo $strsql;
...
function open()
{
	...
	while($row=oci_fetch_assoc($q)){
		...
		$adel="<a href='users_del.php?id_user=$id_user'><img src='../images/img_del.png' onclick='return confirm(\"Apakah anda Yakin??\")'></a>";
		$aedit="<a href='users_edit.php?id_user=$id_user' onmouseover=\"ddrivetip('Edit User', 40)\" onmouseout=\"hideddrivetip()\"><img src='../images/img_edit.png' border='0'></a>&nbsp;";		
		$data.="<tr class='$class'>
            ...
            <table width="100%" border="0">
              <tr>
                ...
                <table width="428" height="111"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="80" valign="top" bordercolor="#999999"><table width="451" border="0" cellpadding="2" cellspacing="2">
                        <thead>
                        <tr class="table_header">
                          <td  width="21" align="center" bordercolor="#999999">No</td>
                          <td  width="100" align="left">Username</td>
                          <td  width="29" align="left">Role</td>
                          <td  width="100" align="left">Password</td>
                          <td  width="48" align="center" >Action</td>
                        </tr>
                        <tr >
                          <td  align="center" bordercolor="#999999" >&nbsp;</td>
                          <td align="left" ><input name="username" type="text" id="username" size="20" class="required"></td>
                          <td align="left"><? 
								$lookup=new Lookup();
								$lookup->name="role";
								$lookup->id="role";					
								$lookup->sql="select * from MN_ROLE";
								$lookup->value_field="KODE_ROLE";
								$lookup->list_field="NAMA_ROLE";
								$lookup->default_value="";					
								$lookup->onchange="";
								echo $lookup->dropdown();
								?>                          </td>
                          <td align="left">
                              <input name="password" type="password" id="password" size="20" class="required">
                          </td>                          
